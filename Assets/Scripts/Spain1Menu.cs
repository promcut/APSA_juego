...
public class Spain1Menu : MonoBehaviour
{
    [SerializeField] GameObject extraMenu;
    //Vector2 pos = new Vector2(346.0f, 65.2f);
    private bool down = false;
    public void LoadScene1(){
        SceneManager.LoadScene(3); //primer nivel
    }
    
    public void LoadScene2(){
        SceneManager.LoadScene(4); //segundo nivel
    }

    public void LoadScene3(){
        SceneManager.LoadScene(5); //primer nivel
    }

    public void LoadScene4(){
        SceneManager.LoadScene(6); //primer nivel
    }

    public void LoadScene5(){
        SceneManager.LoadScene(7); //primer nivel
    }

    public void LoadScene6(){
        SceneManager.LoadScene(8); //primer nivel
    }
    public void LoadSpecialGame(){
        SceneManager.LoadScene(18); //buscando a wally
    }
    public void GoBack(){
